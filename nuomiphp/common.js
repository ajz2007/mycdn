$(function () {
    ...
    if ($question.size() > 0 && Config.loadmode === 'infinite') {
        var maxLoadPage = $question.data("max-load-page") ? parseInt($question.data("max-load-page")) : 0;
        ...
        $(window).scroll(function () {
            if (!$question.data("loading") && (!$question.data("page") || (maxLoadPage ? parseInt($question.data("page")) <= maxLoadPage : true)) && !$(".loadmore-nodata", $question).size() && $question.data("more")) {
